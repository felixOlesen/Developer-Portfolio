...
<div class="flex flex-col md:flex-row place-content-center border-gray-300 md:border-b-1 bg-[#F6F2EB] items-center">
    <div class="flex flex-row border-gray-300 border-b-1 md:border-0 w-full md:w-7/16 items-center p-2 gap-2">
        <div class="px-3 py-1 rounded-lg bg-black"><p class="text-xl">F</p></div>
        <p class="text-lg text-gray-600">Felix Sylvest Olesen</p>
        <p class="text-sm text-gray-600 font-extralight">- Software Engineer</p>
    </div>
    <div class="flex overflow-x-scroll w-full h-full place-content-start md:place-content-end border-gray-300 border-b-1 md:border-0 md:w-7/16 md:h-full items-center">
