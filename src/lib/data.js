// 1. IMPORT ALL LOCAL IMAGES HERE USING THE $lib ALIAS AND ?enhanced FLAG
import aboutMeGraduate from '$lib/assets/aboutMe/aboutMeGraduate.webp?enhanced';

import gibbonDevSite from '$lib/assets/gibbon/gibbonDevSite.webp?enhanced';
import ichkMainSite from '$lib/assets/gibbon/ichkMainSite.webp?enhanced';
import ichkSecondaryGibbon from '$lib/assets/gibbon/ichkSecondaryGibbon.webp?enhanced';

import skyBeReal from '$lib/assets/sky/skyBeReal.webp?enhanced';
import skyCentral from '$lib/assets/sky/skyCentral.webp?enhanced';
import sky4 from '$lib/assets/sky/sky4.webp?enhanced';
import sky4Interior from '$lib/assets/sky/sky4Interior.webp?enhanced';

import portfolioHomePage from '$lib/assets/portfolioProject/portfolioMain.webp?enhanced';
import portfolioProjectPage from '$lib/assets/portfolioProject/portfolioProjects.webp?enhanced';
import portfolioAboutMe from '$lib/assets/portfolioProject/portfolioAboutMe.webp?enhanced';

import aquetect1 from '$lib/assets/aquetect/aquetect1.webp?enhanced';
import aquetect2 from '$lib/assets/aquetect/aquetect2.webp?enhanced';
import aquetect3 from '$lib/assets/aquetect/aquetect3.webp?enhanced';

import quadre1 from '$lib/assets/quadRe/quadre1.webp?enhanced';
import quadre2 from '$lib/assets/quadRe/quadre2.webp?enhanced';
import quadre3 from '$lib/assets/quadRe/quadre3.webp?enhanced';

import bugsTDFMainMenu from '$lib/assets/bugsTDF/bugsTDFMainMenu.webp?enhanced';
import bugsTDFWelcome from '$lib/assets/bugsTDF/bugsTDFWelcome.webp?enhanced';
import bugsTDFLevel2 from '$lib/assets/bugsTDF/bugsTDFLevel2.webp?enhanced';
import bugsTDFLevel3 from '$lib/assets/bugsTDF/bugsTDFLevel3.webp?enhanced';
import bugsTDFLevel1GameOver from '$lib/assets/bugsTDF/bugsTDFLevel1GameOver.webp?enhanced';

import arlpcg1 from '$lib/assets/arlpcg/arlpcg1.webp?enhanced';
import arlpcg2 from '$lib/assets/arlpcg/arlpcg2.webp?enhanced';
import arlpcg3 from '$lib/assets/arlpcg/arlpcg3.webp?enhanced';

import deepLearning1 from '$lib/assets/deepLearning/deepLearning1.webp?enhanced';
import deepLearning2 from '$lib/assets/deepLearning/deepLearning2.webp?enhanced';

import algoVis1 from '$lib/assets/algoVis/algoVis1.webp?enhanced';
import algoVis2 from '$lib/assets/algoVis/algoVis2.webp?enhanced';
import algoVis3 from '$lib/assets/algoVis/algoVis3.webp?enhanced';

import gmw1 from '$lib/assets/gmw/gmw1.webp?enhanced';
import gmw2 from '$lib/assets/gmw/gmw2.webp?enhanced';

import pba1 from '$lib/assets/pba/pba1.webp?enhanced';
import pba2 from '$lib/assets/pba/pba2.webp?enhanced';
import pba3 from '$lib/assets/pba/pba3.webp?enhanced';

import ee1 from '$lib/assets/educationEvolved/ceasefireMainMenu.webp?enhanced'
import ee2 from '$lib/assets/educationEvolved/ceasefire_dialogue.webp?enhanced'
import ee3 from '$lib/assets/educationEvolved/HELM_office_deck.webp?enhanced'
import ee4 from '$lib/assets/educationEvolved/ceasefire_contributions.webp?enhanced'

import akiReadme from '$lib/assets/akiDetection/akiDetector.webp?enhanced'

import butterflyClassifier from '$lib/assets/butterflyClassifier/butterflyClassifier.webp?enhanced'
...
export const aboutMe = {
    ...
    hobbyList: ['Running', 'Hiking', 'Crochet', 'Gaming', 'Pixel Art'],
    media: aboutMeGraduate // Replaced string with imported variable
}
...
export const experience = [
    {
        ...
        overviewMedia: [ee1, ee2, ee3, ee4], // Replaced strings with imported variables
        githubLink: '',
        alternateLinks: { EducationEvolved:'https://www.educationevolvedltd.com', Ceasefire:'https://ceasefire-theta.vercel.app'},
    ...
    },
    {
        ...
        skills: ['PHP', 'SQL', 'JavaScript', 'Tailwind', '+2'],
        filterable: 'softwareDev',
        ...
        overviewMedia: [gibbonDevSite, ichkMainSite, ichkSecondaryGibbon], // Replaced strings with imported variables
        githubLink: 'https://github.com/GibbonEdu/core',
        alternateLinks: { Gibbon:'https://gibbonedu.org'},
    ...
    },
    {
        ...
        skills: ['Python', 'VueJS', 'Tailwind', 'Flask', '+5' ],
        ...
        overviewMedia: [sky4, skyCentral, skyBeReal, sky4Interior], // Replaced strings
        githubLink: '',
        alternateLinks: {Sky:'https://www.sky.com/tv/sky-q'},
...
export const projects = [
    ...
    },
    {
        ...
        skills: ['Python', 'Docker', 'Grafana', 'Kubernetes', '+2'],
        filterable: 'softDev',
        ...
        overviewMedia: [akiReadme],
        githubLink: 'https://github.com/felixOlesen/AKI-Detector',
        alternateLinks: {},
        overviewDuration: 'January 2026 - March 2026',
        technologies: ['https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original.svg', 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg', 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-original.svg', 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/grafana/grafana-original.svg', 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/kubernetes/kubernetes-original.svg'],
    ...
    },
    {
        ...
        skills: ['TypeScript', 'Svelte', 'Figma', 'Tailwind', '+3'],
        filterable: 'softDev',
        ...
        overviewMedia: [portfolioHomePage, portfolioProjectPage, portfolioAboutMe],
    ...
    },
    {
        ...
        skills: ['C#', 'Unity', 'Game Design', 'Aseprite', '+2'],
        filterable: 'gameDev',
        ...
        overviewMedia: [aquetect2, aquetect1, aquetect3],
        githubLink: '',
        alternateLinks: {},
    ...
    },
    {
        ...
        skills: ['C#', 'Unity', 'Github', 'Game Design', '+1'],
        filterable: 'gameDev',
        ...
        overviewMedia: [quadre3, quadre1, quadre2,],
        githubLink: '',
        alternateLinks: {},
    ...
    },
    {
        ...
        overviewMedia: [bugsTDFMainMenu, bugsTDFWelcome, bugsTDFLevel2, bugsTDFLevel3, bugsTDFLevel1GameOver],
        githubLink: 'https://github.com/felixOlesen/BugsTDF',
        alternateLinks: {ItchIO:'https://atomicblitz.itch.io/bugs-tdf'},
    ...
    },
    {
        ...
        skills: ['Deep RL', 'Unity', 'C#', 'Python', '+3'],
        ...
        overviewMedia: [arlpcg3, arlpcg1, arlpcg2],
        githubLink: 'https://github.com/felixOlesen/IL-ARLPCG',
        alternateLinks: {YouTube:'https://www.youtube.com/watch?v=DcBS5_sZu2M'},
    ...
    },
    {
        ...
        skills: ['Python', 'Pytorch', 'ML', 'Computer Vision'],
        filterable: 'machineLearning',
        ...
        overviewMedia: [deepLearning1, deepLearning2],
        githubLink: '',
        alternateLinks: {},
    ...
    },
    {
        ...
        skills: ['Python', 'Optimisation Algorithms', 'PSO', 'Genetic Algorithms'],
        filterable: 'machineLearning',
        ...
        overviewMedia: [algoVis2, algoVis1, algoVis3],
    ...
    },
    {
        ...
        skills: ['Python', 'Optimisation Algorithms', 'ML', 'Computer Vision'],
        filterable: 'machineLearning',
        ...
        overviewMedia: [gmw1, gmw2],
        githubLink: '',
        alternateLinks: {Paper:'https://arxiv.org/abs/2301.08950'},
    ...
    },
    {
        ...
        skills: ['R', 'Data Analytics', 'Clustering', 'Web-Scraping'],
        filterable: 'machineLearning',
    ...
    },
    {
        ...
        skills: ['Ruby', 'Rails', 'BootStrap', 'Testing', '+1'],
        filterable: 'softDev',
    ...
    },
    {
        ...
        skills: ['Python', 'TensorFlow', 'ML', 'Computer Vision'],
        filterable: 'machineLearning',
        ...
        overviewMedia: [butterflyClassifier],
        githubLink: '',
        alternateLink: '',
        overviewDuration: 'September - December 2020',
